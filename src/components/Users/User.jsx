export const User = ({email, first_name, last_name, avatar, isInvited, onChoosePerson}) => (
	<li>
		<div>
		...
		<img className="action" src={`/assets/${isInvited ? 'minus' : 'plus'}.svg`} alt="Action" onClick={onChoosePerson} />
	</li>
);
